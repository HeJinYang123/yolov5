# train
python train.py --weights ./weights/yolov5n.pt --cfg ./models/yolov5n.yaml --data ./data/armor.yaml --hyp ./data/hyps/hyp.scratch_armor.yaml --epochs 2000 --imgsz 512 --batch-size 20 --adam
